...
Isso foi necessário, pois durante os testes foi observado que sem essas linhas, o script pode falhar. O erro ocorre porque o banco de dados pode não existir ainda
